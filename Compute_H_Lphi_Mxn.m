function H_Lphi_Mxn = Compute_H_Lphi_Mxn(LSM_prior, xn, Channel_Para, BSloc)
%UNTITLED2 计算在测量位置 xn 处测量获得的测量方向上的条件熵
%   分为四步，
%   1). 自身栅格的条件熵   
%   2). 栅格与基站连线间的条件熵
%   3). 栅格之后的条件熵
...
H_Lphi_Mxn = H_l_m_xn + sum(H_l_m_x1) + sum(H_l_m_x2);
